...
function validateForm(e) {
  ...
  if ($nameInput.value.trim() === "") {
    ...
    $nameError.innerText = "Solo letras y espacios son validos";
    isValid = false;
  }
  ...
  if ($passwordInput.value.trim() === "") {
    ...
    $passwordError.innerText = "La contraseña debe contener  al menos un número, una letra mayúscula, una letra minúscula y un carácter especial.";
    isValid = false;
  }
  ...
  if (!isValid) {
    ...
    setTimeout(function(e){
        $successMessage.innerText = "Formulario enviado";
        $form.reset();
